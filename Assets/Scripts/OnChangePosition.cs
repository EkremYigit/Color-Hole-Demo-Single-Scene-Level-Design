...
public class OnChangePosition : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 holeFirstPos;
    ...
    public void ReStartPos() //when the game is restart or level completed this function will be called.
    {
        transform.position = holeFirstPos;
        _progressFlag = false;
    }
}